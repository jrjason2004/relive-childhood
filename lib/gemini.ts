...
- "imagePrompt": a SHORT clause (about 5-12 words) naming ONLY what the child is holding or doing with the era-specific object — nothing else. It gets dropped into "A first-person POV photo from a 7-year-old child's low perspective, <imagePrompt>. In the attached scene." so start with a verb like holding/gripping/clutching/carrying/trading/eating and name the specific era-correct object from ${childhoodSpan}. NEVER name or append the location — no "at <place>", no venue/pool/store/theater/park name — the attached reference photo already shows where it is. Also no camera, lighting, people, or era words.
  RIGHT: "holding a sticky red Bomb Pop and a wet pool wristband"
  RIGHT: "holding an iPhone 6 running Pokémon Go"
  WRONG: "holding a sticky red Bomb Pop and a wet pool wristband at Brambleton Community Center Pool" (names the place)
